...
Piece.drawPawn = (function (ctx, player, x, y) {
    ctx.save();
    ctx.translate(x, y);
...
Piece.drawKing = (function (ctx, player, x, y) {
    ctx.save();
    ctx.translate(x, y);
...
Piece.drawRook = (function (ctx, player, x, y) {
    ctx.save();
    ctx.translate(x, y);
...
Piece.drawKnight = (function (ctx, player, x, y) {
    ctx.save();
    ctx.translate(x, y);
...
Piece.drawBishop = (function (ctx, player, x, y) {
    ctx.save();
    ctx.translate(x, y);
...
Piece.drawQueen = (function (ctx, player, x, y) {
    ctx.save();
    ctx.translate(x, y);
